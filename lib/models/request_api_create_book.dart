...
RequestApiCreateBook requestApiCreateBookFromJson(String str) => RequestApiCreateBook.fromJson(json.decode(str));
String requestApiCreateBookToJson(RequestApiCreateBook data) => json.encode(data.toJson());
class RequestApiCreateBook {
  RequestApiCreateBook({
      Book? book,}){
    _book = book;
}

  RequestApiCreateBook.fromJson(dynamic json) {
    _book = json['book'] != null ? Book.fromJson(json['book']) : null;
  }
  Book? _book;
RequestApiCreateBook copyWith({  Book? book,
}) => RequestApiCreateBook(  book: book ?? _book,
);
  Book? get book => _book;
